<?php
/**
 * Basic entity class that gets extended by the final entities.
 * Offers automatic getters and setters that are compatible with the type of the parameter
 * and reads the values from an associative array (request or database results
 */
class GS_Entity {
